...
//         rolesAllowed: newPath.rolesAllowed.split(","),
//       }),
//     });
...
//   const handleUpdateRoles = async (pathname, rolesAllowed) => {
//     setIsLoading(true);
...
//             ? rolesAllowed // If rolesAllowed is already an array, use it as is
//             : rolesAllowed
//                 .split(",")                       // Otherwise, split it by commas
...
//       path.pathname === pathname ? { ...path, rolesAllowed: rolesAllowed.split(",") } : path
//     );
...
//           <input
//             type="text"
//             value={newPath.rolesAllowed}
//             onChange={(e) => setNewPath({ ...newPath, rolesAllowed: e.target.value })}
//             required
//           />
//         </div>
...
//               <input
//                 type="text"
//                 value={path.rolesAllowed.join(",")}
//                 onChange={(e) => handleUpdateRoles(path.pathname, e.target.value)}
//               />
//               <button onClick={() => handleUpdateRoles(path.pathname, path.rolesAllowed)}>
//                 Update
//               </button>
//               <button onClick={() => handleDeletePath(path.pathname)}>Delete</button>
//             </div>
//           </li>
//         ))}
//       </ul>
